...
from utils.dpr_utils import get_config

if __name__ == '__main__':
    
    # Setup
    config            = get_config('config_embedding_dpr.yaml')
    ...
    with distributed_state.split_between_processes(wiki) as shared_wiki:
        ...
        np.save(f"embeddings/wiki_shard_{distributed_state.process_index}.npy", doc_embeddings)