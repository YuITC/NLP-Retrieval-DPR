...
from dpr_utils import get_logger, set_seed, normalize_document, normalize_query, get_config, get_linear_scheduler
...
if __name__ == '__main__':
    ...
    # Setup
    config = get_config('/kaggle/input/dpr-config/config_train_dpr.yaml')
